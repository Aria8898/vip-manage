...
- `VITE_STATUS_SITE_ORIGIN`：管理端生成用户状态页链接时使用的站点域名，例如 `https://status.example.com`
...
VITE_STATUS_SITE_ORIGIN=https://status.example.com
